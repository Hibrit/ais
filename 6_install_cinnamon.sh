...
sudo pacman -Sy --needed --noconfirm xorg lightdm cinnamon alacritty papirus-icon-theme ttf-input ttf-ubuntu-font-family ttf-fira-code ttf-nerd-meslo neofetch htop gnome-keyring mpv youtube-dl eog mupdf firefox qalculate-gtk
