...
sudo pacman -Sy --needed --noconfirm xorg lightdm cinnamon alacritty papirus-icon-theme ttf-input ttf-ubuntu-font-family ttf-fira-code ttf-meslo-nerd neofetch htop gnome-keyring mpv youtube-dl eog mupdf firefox qalculate-gtk

yay -Sy --needed --noconfirm lightdm-mini-greeter mint-themes papirus-folders bibata-cursor-theme-bin visual-studio-code-bin ookla-speedtest-bin
